...
func NewHandlerRegistry() *HandlerRegistry {
    ...
    registry.Register(common.ExecuteCommand, &ExecuteCommandHandler{})
...
func (h *ExecuteCommandHandler) Handle(hctx *HandlerContext) error {
    ...
    ctx := context.Background()
    response, err := hctx.Agent.ExecuteCommand(ctx, req)
    if err != nil {
        return err
    }
